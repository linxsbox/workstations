  ...
  >
    <defs>
      <linearGradient
        ...
        y2="43"
      >
        <stop offset="0%" stop-color="#25B4E1"></stop>
        <stop offset="50%" stop-color="#85C5D0"></stop>
        <stop offset="100%" stop-color="#E5D5BE"></stop>
      </linearGradient>
      <linearGradient
        id="prefix__d"
        spreadMethod="pad"
    ...
    <g clip-path="url(#prefix__a)">
      <g display="block">
        <ellipse
          ...
          cx="14"
          cy="15"
          style="transform-origin: 50%; transform: rotate(52deg)"
        ></ellipse>
        <path
          fill="url(#prefix__b)"
